<?php
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST') {
      ...
      $destinataire = 'quentin.boyer1530@gmail.com'; // Adresse email du webmaster (à personnaliser)
      ...
      header("location:../../recettes.php"); // Afficher un message pour indiquer que le message a été envoyé
